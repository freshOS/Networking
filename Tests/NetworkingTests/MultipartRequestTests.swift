...
//    
//    let client: NetworkingClient = NetworkingClient(baseURL: "https://example.com/")
//    let route = "/api/test"
//
...
//
//        // Construct request
//        let request = client.request(.post, route, params: params)
//        request.multipartData = [multipartData]
//
//        if let urlRequest = client.buildURLRequest(from: request),
