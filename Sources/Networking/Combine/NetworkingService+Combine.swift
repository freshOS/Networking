...
//    func get(_ route: String, params: Params = Params()) async -> AnyPublisher<Data, Error> {
//        await network.get(route, params: params)
//    }
//    
//    func post(_ route: String, params: Params = Params()) async -> AnyPublisher<Data, Error> {
//        await network.post(route, params: params)
//    }
//    
//    func post(_ route: String, body: Encodable & Sendable) async -> AnyPublisher<Data, Error> {
//        await network.post(route, body: body)
//    }
//    
